...
export const resourceSchemas: Record<string, ResourceSchema> = {
  ...
  projects: {
    ...
    fields: [
      ...
      { name: 'relatedPublications', label: 'Related publications', type: 'tags', placeholder: 'Type and press Enter' },
  ...
  experience: {
    ...
    fields: [
      ...
      { name: 'achievements', label: 'Achievements', type: 'tags', placeholder: 'Type and press Enter' },
      { name: 'logo', label: 'Logo', type: 'image' },
      { name: 'image', label: 'Image', type: 'image' },
      { name: 'relatedSkills', label: 'Related skills', type: 'tags', placeholder: 'Type and press Enter' },
      visibilityField,
      orderField,
    ],
  },
